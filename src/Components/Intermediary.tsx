            ...
            <div className="flex-grow flex justify-center  px-4">
                ...
                <div className="text-center text-white w-full max-w-5xl px-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
                        ...
                        {/* v3 Acquisition */}
                        <div className="flex flex-col md:flex-row items-center justify-between space-y-5 md:space-y-0">
                            <img src={acquisitionImageV3} alt="v3 Acquisition" className="w-full md:w-1/2 rounded-lg" />
                            <div className="text-left space-y-4 mx-5">
                                ...
                                <Link to={"/Search"}>
                                    <button className="bg-yellow-300 mt-3 mb-3 text-zinc-900 hover:bg-yellow-100 text-base md:text-lg font-bold py-3 md:py-2 px-6 md:px-6 rounded-full transition duration-300 text-roboto">
                                        v3 Acquisitions
                                    </button>
                                </Link>
                            </div>
