...
const Acquisition: React.FC = () => {
  ...
  return (
    <div className="bg-zinc-950 min-h-screen flex flex-col">
      ...
      <div className="my-3 ml-3 flex gap-2">
        <Link to="/">
        ...
        <button
          onClick={() => navigate(-1)}
          className="bg-zinc-800 text-gray-100 hover:bg-zinc-700 text-base md:text-lg font-bold py-1 px-3 rounded-full transition duration-300 text-roboto"
        >
          ← Back
        </button>
      </div>
      ...
      {errorMsg && (
        <div className="mx-4 mb-2 bg-red-900 text-red-100 text-sm px-3 py-2 rounded border border-red-700">
          {errorMsg}
        </div>
      )}
      ...
      <div className="flex justify-center px-4 pb-4">
        ...
        <main className="w-full max-w-7xl grid gap-4 lg:grid-cols-3 items-start">
          ...
          <section className="lg:col-span-2 bg-zinc-900 border border-zinc-800 rounded-lg p-4 flex flex-col gap-4">
            <div className="w-full">
              <h2 className="text-xl text-yellow-200 mb-2">
                Acquisition {acqId}
              </h2>

              <div className="relative w-full rounded overflow-hidden bg-black aspect-video min-h-[220px] md:min-h-[260px] lg:min-h-[300px]">
                {loading ? (
            ...
            <div className="w-full flex flex-col md:flex-row gap-4">
              <div className="flex-1 bg-zinc-950 border border-zinc-800 rounded p-3">
                <h3 className="text-lg text-yellow-200 mb-2">Active Filters</h3>
                {filterTags.length === 0 ? (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {filterTags.map((tag, idx) => (
                      <span
                        key={idx}
                        className="bg-zinc-800 text-gray-100 text-xs px-2 py-1 rounded-full border border-zinc-700"
                      >
              ...
              <div className="flex-1 bg-zinc-950 border border-zinc-800 rounded p-3">
                <h3 className="text-lg text-yellow-200 mb-2">Downloads</h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {downloadLinks.map((d) => (
                      <a
                        ...
                        className="bg-teal-900 hover:bg-teal-800 text-teal-100 text-xs px-3 py-1 rounded-full border border-teal-700 font-semibold"
                      >
                        {d.ext}
                      </a>
                    ))}
          ...
          {/* Photos */}
          <section className="lg:col-span-1 bg-zinc-900 border border-zinc-800 rounded-lg p-4 flex flex-col">
            <h2 className="text-xl text-yellow-200 mb-2">Photos</h2>
            ...
            {loading ? (
              ...
              <div className="border border-zinc-800 rounded p-2 bg-zinc-950 overflow-y-auto max-h-[28rem] w-full">
