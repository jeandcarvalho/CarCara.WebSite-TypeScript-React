...
<header className="bg-zinc-900 flex  px-3 ">
    ...
    <div className="flex items-center justify-center mt-11" > 
     <div className="text-center text-white mb-11 mt-11">
        ...
        <p className="bg-yellow-300 text-zinc-900 hover:bg-yellow-100 text-lg ml-7 mr-7 font-bold py-2 px-6 rounded-full transition duration-300 text-roboto">Explore Acquisitions  </p>
        </Link> 
