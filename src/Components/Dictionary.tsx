                ...
                <div className="w-full max-w-5xl px-3 mx-4 text-center text-white py-3">
                    ...
                    <div className="mt-8 p-4 md:p-6 bg-zinc-900 rounded-lg shadow-lg text-base md:text-lg font-medium text-roboto text-white">
                        ...
                        <p className="mb-4">
                            ...
                            <pre className="bg-gray-800 p-2 rounded">timestamps: 2024-01-29 14:35:07.399525664-03:00<br />gps_x: -24.436697<br />gps_y: -49.84732<br />gps_z: 1076.8</pre>
                        </p>
                        ...
                        <p className="mb-4">
                            ...
                            <pre className="bg-gray-800 p-2 rounded">timestamps: 2024-01-29 14:35:07.399525664-03:00<br />Aceinna_AccX: 0.14<br />Aceinna_AccY: 0.47<br />Aceinna_AccZ: 9.99<br />LongitudinalAccelerationProc: 0.5<br />LongitudinalAccelerationExtented: 127<br />TransversalAcceleration: 0.064<br />Pitch_Angular_Rate: -0.890625<br />Roll_Angular_Rate: -0.140625<br />Yaw_Angular_Rate: -2.0703125</pre>
                        </p>
                        ...
                        <p className="mb-4">
                            ...
                            <pre className="bg-gray-800 p-2 rounded">timestamps: 2024-01-29 14:35:07.399525664-03:00<br />BatteryVoltage_V2: 14.22<br />BatteryVoltage: 227</pre>
                        </p>
                        ...
                        <p className="mb-4">
                            ...
                            <pre className="bg-gray-800 p-2 rounded">timestamps: 2024-01-29 14:35:07.399525664-03:00<br />SteeringWheelAngle: 9.7<br />SteeringWheelAngle_Offset: -1.1<br />SteeringWheelRotationSpeed: -7.3</pre>
                        </p>
                        ...
                        <p className="mb-4">
                            ...
                            <pre className="bg-gray-800 p-2 rounded">timestamps: 2024-01-29 14:35:07.399525664-03:00<br />FuelTemperature: 0<br />FuelAutonomyInKm: 1023<br />FuelLevelDisplayed: 46<br />FuelConsumption: 4400.0<br />NominalFuelConsumption: 4400.0</pre>
                        </p>
                        ...
                        <p className="mb-4">
                            ...
                            <pre className="bg-gray-800 p-2 rounded">timestamps: 2024-01-29 14:35:07.399525664-03:00<br />VehicleSpeed: 74.89<br />WheelSpeed_F_L: 591.7647<br />WheelSpeed_F_R: 593.4327<br />WheelSpeed_R_L: 589.4295<br />WheelSpeed_R_R: 590.8473<br />FourWheelReferenceSpeed: 655.35<br />DisplayedSpeed: 65535<br />BrakingPressure: 0.0<br />MastervacPressure: 0.0<br />BrakingPressure_Fast: 0.0</pre>
                        </p>
